...
# =========================================================
# ASK GEMINI (ปรับปรุง Prompt บังคับถามเรื่องการนอน)
# =========================================================
...
def ask_gemini(user_message: str, has_logged_today: bool, user_profile: dict = None):
    ...
    # กำหนดแนวทางสนทนาแบบเด็ดขาด
    if has_logged_today:
        conversation_guideline = (
            "1. ผู้ใช้บันทึกข้อมูลสุขภาพวันนี้แล้ว ให้ตอบรับอย่างเป็นมิตร ให้ความรู้/คำแนะนำสุขภาพทั่วไป\n"
            "2. ห้ามถามชวนบันทึกข้อมูลสุขภาพประจำวันซ้ำอีก"
        )
    else:
        conversation_guideline = (
            "1. ตอบรับ/ขอบคุณข้อมูลที่ผู้ใช้เพิ่งส่งมาอย่างเป็นมิตร (เช่น รับทราบเรื่องอายุ/น้ำหนัก)\n"
            "2. **บังคับถาม:** ต้องถามถึง 'ข้อมูลสุขภาพประจำวัน' ทันที โดยเน้นเรื่อง **'เมื่อคืนนอนไปกี่ชั่วโมง'** หรือเรื่องการออกกำลังกาย/ความเครียด เพื่อนำข้อมูลไปลงตาราง health_logs\n"
            "3. ห้ามโฟกัสกับการไล่ถามโปรไฟล์ (เพศ/ส่วนสูง/น้ำหนัก) ให้ถามเรื่องการนอนหรือสุขภาพประจำวันก่อนเป็นอันดับแรก"
        )
...
กฎการสกัดข้อมูล:
1. หากผู้ใช้ระบุข้อมูลส่วนบุคคล (อายุ, เพศ, น้ำหนัก, ส่วนสูง, โรคประจำตัว) ให้สกัดใส่ใน user_profile_update ทันที
2. หากผู้ใช้ระบุข้อมูลสุขภาพประจำวัน (นอนกี่ชั่วโมง, ออกกำลังกายกี่นาที, ความเครียด 1-10 ฯลฯ) ให้สกัดใส่ฟิลด์หลักทันที

ลำดับการตอบกลับใน reply_text (ต้องทำตาม strict rule นี้):
{conversation_guideline}
